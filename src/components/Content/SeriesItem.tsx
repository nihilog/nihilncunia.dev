...
export function SeriesItem({
  ...
  const style = {
    default: css([
      router.query.series === series && tw` bg-blue-500! border-blue-500! text-white! dark:( bg-yellow-300! border-yellow-300! text-black-base! ) hover:( [span]:( bg-white! text-blue-600! ) ) hover:dark:( [span]:( bg-black-600! text-yellow-300! ) ) `,
    ]),
    count: css([
      ...
      router.query.series === series && tw` bg-white text-blue-600 dark:( bg-black-600 text-yellow-300 ) font-500 `,
    ]),
  };
