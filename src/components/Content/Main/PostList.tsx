      ...
      <div>
        ...
        <div css={style.list}>
          ...
          {series && posts.map((post, index) => (
            ...
            >
              <div tw='bg-black-base basis-[50px] text-white p-2 flex items-center justify-center'>{index + 1}</div>
              <div tw='flex gap-5 p-3 bg-white border border-black-200 w-full items-start'>
                <div tw='flex flex-col gap-2 flex-1 shrink-0'>
                  ...
                  <div tw='flex-1 shrink-0 text-[90%] text-black-base'>{post.description}</div>
                </div>
                <img
